...
async function loadFirebaseData() {
    try {
        ...
        for (let i of rawList) {
            ...
            if (msgLow.includes("channel") || msgLow.includes("feedback share") || msgLow.includes("cv accepted") || msgLow.includes("interview guidance") || msgLow.includes("call") || msgLow.includes("ca firms") || msgLow.includes("related updates") || msgLow.includes("visited") || msgLow.includes("calling") || msgLow.includes("another toop")) {
                continue; 
            }
