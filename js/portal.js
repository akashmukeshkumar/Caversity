...
const academicSubjects = [
    { id: 'caf1', name: 'CAF 1: Financial Accounting and Reporting', description: 'Master the core principles of financial accounting, double-entry bookkeeping, and preparation of financial statements.', price: 200, type: 'premium', url: 'subjects/caf1/index.html' },
    { id: 'caf2', name: 'CAF 2: Taxation Principles and Compliance', description: 'Develop a comprehensive understanding of income tax laws, sales tax principles, and practical compliance requirements.', price: 200, type: 'premium', url: 'subjects/caf2/index.html' },
    { id: 'caf3', name: 'CAF 3: Data, Systems and Risks', description: 'Learn about information systems, data management, and the assessment and mitigation of business and IT risks.', price: 200, type: 'premium', url: 'subjects/caf3/index.html' },
    { id: 'caf4', name: 'CAF 4: Business Law Dynamics', description: 'Explore the legal frameworks, contract laws, and principles governing dynamic business operations and partnerships.', price: 200, type: 'premium', url: 'subjects/caf4/index.html' },
    { id: 'caf5', name: 'CAF 5: Management Accounting', description: 'Gain expertise in cost analysis, budgeting, variance analysis, and performance measurement for effective management.', price: 200, type: 'premium', url: 'subjects/caf5/index.html' },
    { id: 'caf6', name: 'CAF 6: Corporate Reporting', description: 'Master advanced financial reporting standards (IFRS) and the preparation of complex corporate financial statements.', price: 200, type: 'premium', url: 'subjects/caf6/index.html' },
    { id: 'caf7', name: 'CAF 7: Business Insights and Analysis', description: 'Develop strategic analytical skills to evaluate business performance, analyze financial data, and drive decision-making.', price: 200, type: 'premium', url: 'subjects/caf7/index.html' },
    { id: 'caf8', name: 'CAF 8: Audit and Assurance Essentials', description: 'Understand the essential methodologies, ethical standards, and procedures for conducting audit and assurance engagements.', price: 200, type: 'premium', url: 'audit.html' },
