...
const academicSubjects = [
    ...
    { id: 'sanctuary', name: 'The Sanctuary', description: 'Spiritual guidance and ethical foundations for professional excellence.', price: 0, type: 'free', url: 'features/html/blueprint.html' }
];
