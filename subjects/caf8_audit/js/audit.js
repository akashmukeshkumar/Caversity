...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const tabData = {
       "#hero-landing": { badge: "Welcome to the Ultimate Audit Experience", title: "Empowering Future Auditors.<br><span class='highlight-blue'>Let’s Build Your Success.</span>", sub: "Master CAF 8 Audit with Caversity. AI-powered checking, interactive concepts, and 24/7 support.", btnText: "", btnLink: "", img: "", overlay: "radial-gradient(circle at 50% 50%, #1a367a 0%, #0c1527 70%, #040914 100%)", rightHtml: homeHTML },
        ...
        "#audit-dose-section": { badge: "Gamified Testing", title: "30-Min <span class='highlight-blue'>Brain Dose</span>", sub: "Take the ultimate challenge! Automatically rotating MCQ scenarios designed to test your real-world audit logic.", btnText: "Solve MCQs Now", btnLink: "#audit-dose-section", img: "https://images.unsplash.com/photo-1606326608606-aa0b62935f2b?q=80&w=1920", overlay: "linear-gradient(135deg, rgba(153,27,27,0.9), rgba(15,23,42,0.8))", rightHtml: getGlassCard("fa-brain", "#ef4444", "Live Scenarios", "Expert Insights") },
